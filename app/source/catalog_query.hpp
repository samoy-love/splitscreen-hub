...
/// Приводит название и поисковый запрос к одному виду: нижний регистр для
/// латиницы и кириллицы, ё читается как е.
///
/// Названия в каталоге сейчас английские, но запрос набирают с русской
/// клавиатуры, а русские названия появятся вместе с данными — ждать поиска с
/// учётом регистра от них не должны.
