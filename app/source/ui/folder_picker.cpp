...
void pick(const std::string& nsuid, std::function<void()> onChanged)
{
    ...
    // свободной кнопки под него нет, а X должен значить одно и то же в каталоге
    // и в карточке. По сути избранное и есть особый список: в сайдбаре
    // библиотеки оно и показано наравне с папками.
    //
